...
class Dataset(Dataset):
    def __init__(
        self, filename, preprocess_config, model_config, sort=False, drop_last=False
    ):
        self.dataset_name = preprocess_config["dataset"]
        self.preprocessed_path = preprocess_config["path"]["preprocessed_path"]
        self.cleaners = preprocess_config["preprocessing"]["text"]["text_cleaners"]
        self.batch_size = model_config["AM"]["batch_size"]
...
if __name__ == "__main__":
    ...
    val_dataset = Dataset(
        "val.txt", preprocess_config, model_config, sort=False, drop_last=False
    )
    train_loader = DataLoader(
        train_dataset,
        batch_size=model_config["optimizer"]["batch_size"] * 4,
        shuffle=True,
    ...
    val_loader = DataLoader(
        val_dataset,
        batch_size=model_config["optimizer"]["batch_size"],
        shuffle=False,
